...
import { authenticate, validateApiKey } from '../middleware/auth.middleware';
 ...
 */
router.get('/', validateApiKey as RequestHandler, WalletController.getAllWallets as RequestHandler);
 ...
 *         description: Internal Server Error
 */
router.get('/user/:userId', authenticate as RequestHandler, WalletController.getUserWallets as RequestHandler);
 ...
 *         description: Internal Server Error
 */
router.get('/:walletId/user/:userId', authenticate as RequestHandler, WalletController.getWallet as RequestHandler);
 ...
 *         description: Internal Server Error
 */
router.post('/', authenticate as RequestHandler, WalletController.createWallet as RequestHandler);
 ...
 *         description: Internal Server Error
 */
router.get('/:walletId/user/:userId/balance', authenticate as RequestHandler, WalletController.getWalletBalance as RequestHandler);
